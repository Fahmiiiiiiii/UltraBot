...
from pyultrabot.fns.misc import get_synonyms_or_antonyms
from pyultrabot.fns.tools import async_searcher

from . import get_string, ultrabot_cmd


@ultrabot_cmd(pattern="meaning( (.*)|$)", manager=True)
