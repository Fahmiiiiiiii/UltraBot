...
from . import eod, eor, get_string, mediainfo, ultrabot_cmd
...
@ultrabot_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@ultrabot_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@ultrabot_cmd(pattern="setpic$", fullsudo=True)
async def _(ult):
    if not ult.is_reply:
...
@ultrabot_cmd(pattern="delpfp( (.*)|$)", fullsudo=True)
