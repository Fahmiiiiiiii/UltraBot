...
from pyultrabot.dB.mute_db import is_muted, mute, unmute
from pyultrabot.fns.admins import ban_time

from . import asst, eod, get_string, inline_mention, ultrabot_bot, ultrabot_cmd
...
async def startmute(event):
    ...
    if input_ := event.pattern_match.group(1).strip():
        ...
        if reply.out or userid in [ultrabot_bot.me.id, asst.me.id]:
