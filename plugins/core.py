...
from pyultrabot.startup.loader import load_addons

from . import LOGS, async_searcher, eod, get_string, safeinstall, ultrabot_cmd, un_plug


@ultrabot_cmd(pattern="install", fullsudo=True)
...
@ultrabot_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)
