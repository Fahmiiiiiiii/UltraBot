...
from pyultrabot.dB.asstcmd_db import add_cmd, cmd_reply, list_cmds, rem_cmd
...
from . import asst, get_string, mediainfo, udB, ultrabot_cmd


@ultrabot_cmd(pattern="addcmd( (.*)|$)")
async def ac(e):
