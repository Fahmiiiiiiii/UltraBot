...
from . import async_searcher, get_random_user_data, get_string, re, ultrabot_cmd


@ultrabot_cmd(pattern="eod$")
async def diela(e):
...
@ultrabot_cmd(pattern="randomuser")
