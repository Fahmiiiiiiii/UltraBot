...
from pyultrabot.fns.misc import unsplashsearch
from pyultrabot.fns.tools import LogoHelper

from . import OWNER_ID, OWNER_NAME, download_file, get_string, mediainfo, ultrabot_cmd


@ultrabot_cmd(pattern="logo( (.*)|$)")
    ...
    if not bg_:
        if event.client._bot:
            ...
            async for i in event.client.iter_messages(
                "@ultrabotLogos", filter=InputMessagesFilterPhotos
            ):
                pics.append(i)
