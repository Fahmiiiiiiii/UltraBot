...
from . import HNDLR, eod, get_string, ultrabot_cmd


@ultrabot_cmd(pattern="(send|dm)( (.*)|$)", fullsudo=True)
async def dm(e):
...
@ultrabot_cmd(pattern="fwdreply( (.*)|$)", fullsudo=True)
async def _(e):
