...
from . import Carbon, eor, get_string, inline_mention, os, ultrabot_cmd
...
async def crbn(event):
    ...
    xx = await Carbon(code=code, file_name="ultrabot_carbon", backgroundColor=col)
    await xxxx.delete()
    await event.reply(
