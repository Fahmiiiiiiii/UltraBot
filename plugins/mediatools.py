...
from pyultrabot.fns.misc import rotate_image
from pyultrabot.fns.tools import make_html_telegraph

from . import LOGS, Telegraph, bash, downloader, get_string, mediainfo, ultrabot_cmd
...
@ultrabot_cmd(pattern="mediainfo( (.*)|$)")
async def mi(e):
