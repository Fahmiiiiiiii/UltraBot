...
from pyultrabot.fns.misc import google_search
from pyultrabot.fns.tools import (
    _webupload_cache,
    async_searcher,
    get_ofox,
    saavn_search,
...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/Teamultrabot/ultrabot"),
        Button.url("• Support •", url="t.me/ultrabotSupportChat"),
    ],
]
...
async def repo(e):
    res = [
        await e.builder.article(
            ...
            text="• **ultrabot USERBOT** •",
            buttons=SUP_BUTTONS,
        ),
    ]
    await e.answer(res, switch_pm="ultrabot Repo.", switch_pm_param="start")
...
async def piston_run(event):
    try:
        ...
        result = await event.builder.article(
            ...
            text=f'**Inline Usage**\n\n`@{asst.me.username} run python print("hello world")`\n\n[Language List](https://graph.org/ultrabot-09-01-6)',
        )
        ...
        return await ult.answer(
            [
                await ult.builder.article(
                    title="How to Use?",
                    description="Tl Searcher by ultrabot",
                    url="https://t.me/Teamultrabot",
                    text=text,
                )
            ],
            switch_pm="Tl Search 🔍",
...
InlinePlugin.update(
    {
        ...
        "Sᴇᴀʀᴄʜ Oɴ Gᴏᴏɢʟᴇ": "go Teamultrabot",
        "WʜɪSᴘᴇʀ": "wspr @username Hello🎉",
        "YᴏᴜTᴜʙᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ": "yt Ed Sheeran Perfect",
        "Piston Eval": "run javascript console.log('Hello ultrabot')",
        "OʀᴀɴɢᴇFᴏx🦊": "ofox beryllium",
        "Tᴡɪᴛᴛᴇʀ Usᴇʀ": "twitter theultrabot",
