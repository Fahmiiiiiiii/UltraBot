...
COPYRIGHT = f"©️ UltraBot {datetime.now().year}"
...
3. Some of the plugins are disabled for 'Termux Users' to save resources (by adding in EXCLUDE_OFFICIAL).
   - Read More - https://t.me/Fahmiiiiiiii/36
...
ᴜʟᴛʀᴀʙᴏᴛ - ᴜsᴇʀʙᴏᴛ ɪɴsᴛᴀʟʟ 
{Style.RESET_ALL}
{Fore.GREEN}- UltraBot Termux Installation -
  The Main Aim of this script is to deploy UltraBot with basic requirements and save your phone resources.
{Fore.RESET}
...
sleep(0.5)
print(
    "\nYou can head over to @UltraBotSupport, if you get stuck somewhere, and need help."
)
sleep(0.5)
print("\nMade with ❤️ by @mailbintisukijem...")
