...
def load_other_plugins(addons=None, pmbot=None, manager=None, vcbot=None):
    ...
    if addons:
        ...
        if not os.path.exists("addons"):
            os.system(
                f"git clone -q -b {Repo().active_branch} https://github.com/Fahmiiiiiiii/UltraBotAddons.git addons"
            )
        else:
        ...
        if not os.path.exists("addons"):
            os.system(
                "git clone -q https://github.com/Fahmiiiiiiii/UltraBotAddons.git addons"
            )
    ...
    if vcbot and not vcClient._bot:
        try:
            ...
            if not os.path.exists("vcbot"):
                os.system("git clone https://github.com/Fahmiiiiiiii/VcBot vcbot")
            try:
