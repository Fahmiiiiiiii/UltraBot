...
class ultrabotClient(TelegramClient):
    def __init__(
        self,
        session,
        api_id=None,
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from pyultrabot.fns.FastTelethon import upload_file
        from pyultrabot.fns.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from pyultrabot.fns.FastTelethon import download_file
        from pyultrabot.fns.helper import progress
