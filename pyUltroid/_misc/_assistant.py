...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/Fahmiiiiiiii/UltraBot",
        ),
        Button.url("Support", url="https://t.me/UltraBotSupport"),
    ]
]
                    ...
                    await event.answer(
                        [
                            await event.builder.article(
                                ...
                                text=error_text(),
                                buttons=Button.url(
                                    "Report", "https://t.me/UltraBotSupport"
                                ),
                            )
                        ]
                    )
