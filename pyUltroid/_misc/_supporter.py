...
#
#   ultrabot Don't Need This Stuffs
#
...
from pyultrabot._misc._decorators import compile_pattern, ultrabot_cmd
...
ALIVE_NAME = ultrabot_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = ultrabot_bot
catub.cat_cmd = ultrabot_cmd
...
command = ultrabot_cmd
register = ultrabot_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "ultrabot")
